...
/* copied from hda_codec.[ch], renamed to avoid conflicts */
#define snd_print_pcm_rates _snd_print_pcm_rates
#define snd_print_pcm_bits _snd_print_pcm_bits

static void snd_print_pcm_rates(int pcm, char *buf, int buflen)
{
...
static void snd_print_pcm_bits(int pcm, char *buf, int buflen)
{
...
#ifdef HDA_CODEC_PIN_AMP_WORKAROUND
